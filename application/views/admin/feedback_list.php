		...
		<div class="content">
			...
			<?php foreach ($feedbacks as $feedback) : ?>
				<div class="card">
					...
					<a href="#" data-delete-url="<?= site_url('admin/feedback/delete/' . $feedback->id) ?>" class="button button-danger button-small" role="button" onclick="deleteConfirm(this)">Delete</a>
				</div>
			<?php endforeach ?>
